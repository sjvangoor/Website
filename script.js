document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        nl: {
            ...
            'index-subtitle': 'Stan van Goor is een creatieve marketingprofessional met een analytische achtergrond. Als Marketing Data Analist bij een snelgroeiend bedrijf vertaalt hij data naar strategische inzichten en voelt hij zich thuis op het snijvlak van data, branding en content.',
            'index-cta': 'Neem contact op',
            'biography-heading': 'Biografie',
            'biography-text': 'Gedreven door nieuwsgierigheid verbindt Stan cijfers met verhalen. Hij onderzoekt graag hoe data merken kan versterken en is een zelfstarter die inzichten omzet in actie.',
            'experience-heading': 'Ervaring',
            'experience-text1': 'In zijn huidige rol bouwt Stan dashboards, analyseert hij advertentieprestaties op Google, Meta en LinkedIn, en levert hij het marketingteam duidelijke inzichten voor betere beslissingen.',
            'experience-text2': 'Daarvoor werkte hij als marketingspecialist bij Student Consultant, waar hij merkstrategie bepaalde, campagnes coördineerde en stagiairs aanstuurde. Hij realiseerde API-koppelingen, bouwde een marketingdatabase en structureerde data uit onder andere Power BI en MySQL. Zo laat hij zien dat hij zowel strategisch denkt als hands-on oplossingen bouwt.',
            'education-heading': 'Opleiding',
            'education-text': 'Stan behaalde een Bachelor of Science in International Business en vervolgens een master in Marketing Analytics. Tijdens zijn studie sloeg hij de brug tussen harde data en zachte merkcommunicatie en hij blijft zich verdiepen in SEO, gedragspsychologie en advertising automation.',
            'skills-title': 'Skills',
            'skills-subtitle': 'Een kort overzicht van de technologieën die Stan gebruikt om responsieve ervaringen te bouwen.',
            ...
            'skills-text2': 'Stan gebruikt ook Figma en Sketch om concepten om te zetten in verfijnde interfaces en toegankelijke gebruikersstromen.',
            'projects-title': 'Projecten',
            'projects-subtitle': 'Een selectie van recente front-end- en designprojecten.',
            'projects-intro': 'Van interactieve prototypes tot dynamische webapps, deze voorbeelden tonen Stan\u2019s veelzijdigheid.',
            'recommendations-heading': 'Aanbevelingen',
            'rec1-quote': 'Werken met Stan was een masterclass in samenwerking. Elk oplevermoment was doordacht en op tijd.',
            'rec2-quote': 'Stans scherpe oog voor design tilde onze app naar een hoger niveau. Het was echt een plezier om mee samen te werken.',
            'ambition-title': 'Ambitie',
            'ambition-subtitle': 'Een kijkje in Stan\u2019s doelen en wat dit werk drijft.',
            'ambition-text1': 'Stan streeft ernaar inclusieve digitale ervaringen te creëren en tegelijk de ontwikkelvaardigheden te blijven aanscherpen.',
            ...
            'contact-subtitle': 'Stan praat graag over het vak. Laat hieronder een bericht achter.',
            ...
            'faq-title': 'FAQ',
            'faq-subtitle': 'Antwoorden op een aantal veelgestelde vragen over Stan\u2019s werk.',
            ...
            'enterprise-rec-quote': 'Stan leverde een robuuste interface waar ons team dagelijks op vertrouwt. De aandacht voor detail was uitstekend.',
            ...
            'realestate-rec-quote': 'Het portaal ziet er fantastisch uit en is ongelooflijk eenvoudig te navigeren. Stan overtrof onze verwachtingen.',
            ...
            'mobile-rec-quote': 'Stan creëerde een mobiele shop waar onze klanten dol op zijn. De verkoop steeg direct na de lancering.',
            ...
            'analytics-rec-quote': 'Stan begreep onze eisen snel en leverde een strak interface waar onze klanten lovend over zijn.',
            ...
            'event-rec-quote': 'Van concept tot lancering zorgde Stan\'s professionaliteit ervoor dat onze conferentie een succes was.',
