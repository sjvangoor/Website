document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        nl: {
            ...
            'index-subtitle': 'Stan van Goor is een front-end ontwikkelaar die graag elegante, toegankelijke interfaces maakt. Een ontwerpachtergrond voedt zijn passie om complexe uitdagingen om te zetten in intuïtieve ervaringen.',
            'index-cta': 'Neem contact op',
            'biography-heading': 'Biografie',
            'biography-text': 'Stan heeft samengewerkt met multidisciplinaire teams aan uiteenlopende web- en mobiele projecten, steeds met focus op gebruiksvriendelijkheid en performance.',
            'experience-heading': 'Ervaring',
            'experience-text1': 'Met meer dan vijf jaar ervaring heeft Stan alles gebouwd, van interactieve prototypes tot volwaardige productie-apps.',
